    ...
    <Drawer title="HELLO, FEELING GOOD TODAY?">
      <Box sx={{ mt: 1, color: '#fff' }}>
        <Grid container gap={2}>
          <Card height={230} xs={12} hover={deepPurple[600]} bgcolor={deepPurple[500]} active={deepPurple[400]} />
          <Grid item xs={12}>
            <Grid container direction="row" justifyContent="space-between" alignItems="center">
              <Card height={230} xs={6} hover={yellow[700]} bgcolor={yellow[600]} active={yellow[500]}>
                <Container sx={{ py: 1 }}>
              ...
              <Card height={230} xs={5} hover={green[600]} bgcolor={green[500]} active={green[400]} />
            </Grid>
          </Grid>
